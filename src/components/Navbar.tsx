        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/signin" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">Home</Link>
              <Link to="#" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">Restaurants</Link>
              <Link to="#" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">My Orders</Link>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative" ref={profileRef}>
                ...
                >
                  ...
                  <span className="hidden lg:block font-medium text-gray-700">John Doe</span>
        ...
        {isMobileMenuOpen && (
          <div ref={mobileMenuRef} className="md:hidden bg-white border-t">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <Link to="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-orange-500 hover:bg-gray-50">Restaurants</Link>
              <Link to="#" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-orange-500 hover:bg-gray-50">My Orders</Link>
            </div>
          </div>
        )}
      </nav>
